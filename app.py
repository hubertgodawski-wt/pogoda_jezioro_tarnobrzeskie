...
try:
    ...
    with tab1:
        ...
        # Dostosowane palety kolorów zawierające ostrzeżenie przed przelotnym deszczem (#4169e1 - royal blue)
    ...
    with tab2:
        ...
        for i in range(len(daily['time'])):
            ...
            for idx in day_indices:
                ...
                # TOLERANCJA W OKIENKACH: Akceptujemy do 1.0 mm drobnego deszczu na godzinę!
